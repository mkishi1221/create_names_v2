...
keyword = Keyword.from_dict({'origin': ['keyword_list'], 'source_words': ['Vibrant'], 'spacy_lemma': None, 'nltk_lemma': 'vibrant', 'hard_lemma': None, 'spacy_pos': None, 'eng_dict_pos': ['adjective'], 'keyword_len': 7, 'spacy_occurrence': 0, 'contained_words': ['ant', 'bra', 'bran', 'brant', 'rant'], 'phonetic_pattern': '2122122', 'phonetic_grade': 'Phonetic_D', 'phonetic_score': 0.04394110742358322, 'lowest_phonetic': 0.002046710622867963, 'implausible_chars': [], 'components': ['vi·brant'], 'abbreviations': ['vi', 'vib', 'vibra'], 'restrictions_before': None, 'restrictions_after': None, 'restrictions_as_joint': None, 'yake_score': 0.0339251285730776, 'yake_rank': 59.0, 'keyword_class': 'prime', 'keyword': 'vibrant', 'pos': 'adjective', 'shortlist': 's'})
