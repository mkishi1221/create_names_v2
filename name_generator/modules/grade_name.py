...
def grade_name(name_type, phonetic_grade, implaus_chars, end_valid, is_it_word, name_length, contained_words, if_wiki_title):
    ...
    if name_type == "cut_name" or name_type == "pref_suff_name":
        if (
            ...
            if phonetic_grade == "Phonetic_A" and len(implaus_chars) <= 1:
                grade_str = "Grade_A"
            elif phonetic_grade == "Phonetic_B" and len(implaus_chars) <= 2:
                grade_str = "Grade_B"
            elif phonetic_grade == "Phonetic_C" and len(implaus_chars) <= 3:
                grade_str = "Grade_C"
            else:
                grade_str = "Grade_D"
        else:
            ...
            if name_length >= 20:
                reject_reason.append("over_19_letters")
    ...
    elif name_type == "part_cut_name" or name_type == "no_cut_name" or name_type == "text_comp_name":

        Top_Phonetics = ["Phonetic_A", "Phonetic_B"]
        ...
        if (
            ...
            if name_length < 11 and phonetic_grade in Top_Phonetics:
                grade_str = "Grade_A"
            elif name_length < 13 and phonetic_grade in Top_Phonetics:
                grade_str = "Grade_B"
            elif name_length < 17 and phonetic_grade != "Phonetic_D" :
                grade_str = "Grade_C"
            else:
                grade_str = "Grade_D"
        else:
